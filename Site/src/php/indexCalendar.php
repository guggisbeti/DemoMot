		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<p class="lead">Cet endroit est réservé au administrateurs, nous vous laissons insérer les données
						validées</p>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label class="text-danger"><input type="checkbox" name="delete">Effacer la
										réservation</label>
								</div>
							</div>
						</div>

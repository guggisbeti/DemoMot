    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <p class="lead">Cet endroit est réservé au administrateurs, nous vous laissons insérer les données validées</p>
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php?type=admin">
			  ...
			  <div class="modal-footer">
				  <button id="saveButtonCalendar" type="submit" class="waves-effect waves-light btn red darken-3">Sauvegarder</button>
				  <button type="button" class="waves-effect waves-light btn blue-grey darken-2" data-dismiss="modal">Fermer</button>
			  </div>
			</form>
			</div>
		  </div>
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
				  ...
				  <div class="form-group">
				    ...
				    <div class="form-group"> 
						<div class="col-sm-offset-2 col-sm-10">
						  <div class="checkbox">
							<label class="text-danger"><input type="checkbox"  name="delete">Effacer la réservation</label>
						  </div>
						</div>
					</div>
			  ...
			  <div class="modal-footer">
				  <button id="saveButtonCalendar" type="submit" class="waves-effect waves-light btn red darken-3">Sauvgarder</button>
				  <button type="button" class="waves-effect waves-light btn blue-grey darken-2" data-dismiss="modal">Fermer</button>
			  </div>
			</form>
			</div>

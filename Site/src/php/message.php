            ...
            <div class="card hoverable small">
                <div class="card-tabs ">
                    <ul class="tabs tabs-fixed-width">
                        ...
                        <li class="tab"><a href="#info<?php echo $messageChange?>">Info</a></li>
                        <!-- Bouton message avec la variable messageChange dans l'URL afin qu'il soit différent pour chaque bouton -->
                        <li class="tab"><a class="active" href="#message<?php echo $messageChange?>">Message</a></li>
                    </ul>
                </div>
                    ...
                    <div id="info<?php echo $messageChange?>">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><a href="deleteMessage.php?id=<?php echo $details['idMessage'] ?>" id="download-button" class="btn waves-effect waves-light <?php if($changeColor == false){echo 'blue-grey darken-2';} else {echo 'red darken-3';} ?>">Supprimer</a></td>
                            </tr>
                        </table>
                    </div>
                    <!-- Même fonctionnement qu'en dessus en mettant l'id changeant à chaque nouvelle card -->

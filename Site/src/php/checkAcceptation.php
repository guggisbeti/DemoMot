                    ...
                    <?php
                        ...
                        foreach($data as $date) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="start" class="form-control" id="start" value="<?php echo $date['resStartDate'] ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="end" class="col-sm-2 control-label">Date de fin</label>
                                <div class="col-sm-10">
                                    <input type="text" name="end" class="form-control" id="end" value="<?php echo $date['resEndDate'] ?>" readonly>
                                </div>
                            </div>
                        <?php
                        }
